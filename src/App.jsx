  ...
  return (
    <>
      ...
      >
        <div>
          ...
          <p className="mt-2 text-sm">
            <span className="before:content-['\2022'] before:mr-2 md:text-2xl">
        ...
        <div className="flex justify-center lg:justify-normal gap-5">
          <button
            ...
            className="px-4 py-2 bg-(--black) text-(--white) md:text-2xl rounded-lg shadow-lg transition-transform duration-200 hover:scale-105 hover:cursor-pointer"
          >
            Contact Me
          </button>
          <button
            onClick={scrollToProject}
            className="px-4 py-2 bg-(--white) text-(--black) md:text-2xl border border-(--black) rounded-lg shadow-lg transition-transform duration-200 hover:scale-105 hover:cursor-pointer"
          >
            MY Project
          </button>
        </div>
        <div
          className="flex gap-2 mt-10 justify-end items-center"
          style={{
            animation: "fadeIn 1s ease-out 1.1s forwards",
            opacity: 0,
          }}
        >
          <p className="text-sm text-right md:text-lg lg:text-xl lg:w-[30vw]">
            With a year of self-taught experience, I specialize in crafting
            engaging front-end designs and simple, effective backend solutions.
          </p>
      ...
      <section
        ...
        className="skills sec2 flex flex-col gap-10 px-10 md:px-25 mt-20"
      >
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-30">
          <ul className="text-lg md:text-xl space-y-3 list-disc lg:w-full lg:text-2xl flex flex-col gap-5 lg:py-5">
            ...
            <li className="ml-4 font-light">
              <span className="font-medium">Front-End:</span>HTML, CSS,
              JavaScript, React, ReactRouter, Tailwind CSS
            </li>
            <li className="ml-4 font-light">
              <span className="font-medium">UI Design:</span>Clean, user-focused
              interfaces
            </li>
            <li className="ml-4 font-light">
              <span className="font-medium">Back-End:</span>Vite.js, Node.js,
              Express, MongoDB, Mongoose (basic APIs, no complex auth and stuff
              yet)
            </li>
            <li className="ml-4 font-light">
              <span className="font-medium">Tools:</span>Vite, Figma, Git
            </li>
          </ul>
          <div className="p-5 flex flex-col gap-5 bg-(--black) rounded-xl text-(--white) lg:w-full">
            ...
            <div className="div flex flex-wrap justify-evenly gap-2 mt-10">
              ...
              >
                <path
                  fill="#800"
                  d="M97.733 46.548a4.2 4.2 0 0 0-.352-1.431 3.3 3.3 0 0 0-.778-1.155 3.3 3.3 0 0 0-1.155-.778q-.652-.301-1.456-.301-.83 0-1.507.3a3.3 3.3 0 0 0-1.13.779q-.476.502-.752 1.18a4.3 4.3 0 0 0-.327 1.406zm2.058 3.615q-.426 2.184-1.883 3.29-1.455 1.104-3.665 1.104-1.557 0-2.712-.502a5.35 5.35 0 0 1-1.908-1.406q-.778-.904-1.18-2.16a10.8 10.8 0 0 1-.426-2.736q0-1.48.452-2.711.451-1.23 1.255-2.134a5.9 5.9 0 0 1 1.933-1.406 6 6 0 0 1 2.46-.503q1.733 0 2.862.729a5.4 5.4 0 0 1 1.833 1.807q.704 1.105.954 2.41.277 1.306.226 2.486h-9.716q-.025.854.201 1.632.225.753.728 1.356.503.577 1.28.928.78.352 1.833.352 1.355 0 2.21-.628.878-.627 1.154-1.908z"
                />
                <path
                  fill="#800"
      ...
      <section
        ref={projectRef}
        className="projects px-10 md:px-25 mt-20 gap-10"
      >
        <div>
          <h1 className="text-2xl md:text-3xl lg:text-4xl">MY Projects</h1>
          <p className="md:text-lg mt-3">
            Here are some projects that showcase my skills in{" "}
            <span className="font-semibold">front-end development</span>, UI
            design, and simple backend integration.
          </p>
        </div>
        <div className="cards flex flex-col md:flex-row justify-between gap-10 lg:gap-30 mt-10">
          <a
            href="https://restaurant-page-the-local-bite.onrender.com/"
            className="card flex flex-col border-1 rounded-xl md:w-full transition-transform duration-200 hover:scale-102"
          >
            ...
            <div className="space-y-2 lg:space-y-4 p-5">
              ...
              <p className="font-light text-sm md:text-base lg:text-lg">
                A responsive restaurant website with a dynamic menu page
                fetching dishes from a MongoDB database.
              </p>
              <button className="text-lg md:text-xl lg:text-2xl underline hover:cursor-pointer transition-transform duration-200 hover:scale-102">
                View Project
              </button>
            </div>
          </a>
          <a
            href="https://github.com/Tawqi/ISP-Proj-2"
            className="card flex flex-col border-1 rounded-xl md:w-full transition-transform duration-200 hover:scale-102"
          >
            <img src={WSP} className="rounded-t-xl" alt="proj1"></img>
            <div className="space-y-2 lg:space-y-4 p-5">
              <h2 className="text-lg md:text-xl lg:text-2xl">Omuk-Tomuk ISP</h2>
              <p className="font-light text-sm md:text-base lg:text-lg">
                A responsive page with a clean Dark & Blue theme .
              </p>
              <button className="text-lg md:text-xl lg:text-2xl underline hover:cursor-pointer transition-transform duration-200 hover:scale-102">
                View Project
              </button>
      ...
      <section
        ref={contactRef}
        className="socials-and-Contact flex flex-col px-10 md:px-25 lg:flex-row gap-10 lg:gap-30 mt-20"
      >
        <div className="flex flex-col gap-5 lg:w-full lg:py-5">
          <div>
            <h1 className="text-2xl md:text-3xl lg:text-4xl">Socials</h1>
            <p className="md:text-lg mt-3">
              Follow me for more updats and stuff.
            </p>
          </div>
          <button
            onClick={() => {
              navigator.clipboard
                .writeText("tawqitahmedchy@proton.me")
                .then(() => alert("Email copied!"))
                .catch(() => alert("Failed to copy"));
            }}
            className="w-full border border-black p-2 px-4 items-center flex justify-between rounded-lg md:py-4 shadow-xl transition-transform duration-200 hover:translate-x-2 hover:cursor-pointer"
          >
          ...
          <a
            href="https://www.facebook.com/profile.php?id=61577903310096"
            className="w-full border border-(--black) p-2 px-4 items-center flex justify-between rounded-lg md:py-4 shadow-xl transition-transform duration-200 hover:translate-x-2 hover:cursor-pointer"
          >
            <span className="flex items-center gap-3">
          ...
          <a
            href="https://www.instagram.com/tawqi0"
            className="w-full border border-(--black) p-2 px-4 items-center flex justify-between rounded-lg md:py-4 shadow-xl transition-transform duration-200 hover:translate-x-2 hover:cursor-pointer"
          >
            <span className="flex items-center gap-3">
        ...
        <div className="p-5 flex flex-col bg-(--black) rounded-xl text-(--white) mt-10 lg:mt-0 shadow-2xl lg:w-full">
          ...
          <form action="/form-message" className="flex flex-col">
            ...
            <input
              ...
              className="border border-(--white) bg-(--white) text-(--black2) text-sm rounded-lg px-3 py-2 p-1 mt-2 md:py-3"
            />
            ...
            />
            <button
              onClick={message_alert}
              className="border border-(--white) bg-(--white) text-(--black2) text-sm rounded-lg px-3 py-2 p-1 mt-8 md:py-3 transition-transform duration-200 hover:scale-102 hover:cursor-pointer"
            >
              Submit
            </button>
          </form>
