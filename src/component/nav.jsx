...
export default function Nav({ contactRef, projectRef, heroRef }) {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${showNav ? 'translate-y-0' : '-translate-y-full'} flex justify-between px-10 md:px-25 py-5 text-black bg-(--white) shoadow-bottom`}>
      ...
      <ul className="hidden lg:flex gap-10 justify-evenly md:text-lg">
        <li onClick={scrollToHero} className="hover:cursor-pointer">Home</li>
